...
New-AzFederatedIdentityCredentials -Name fic2-demo-gha -IdentityName uami-demo-gha -ResourceGroupName $resourceGroupName_UAMI -Issuer "https://token.actions.githubusercontent.com" -Subject "repo:alexandair/demo-gha:environment:Website" -Audience "api://AzureADTokenExchange"
...
Get-MgApplication -Filter 'DisplayName eq "Testapp"'
# invalid
Get-MgApplication -ConsistencyLevel eventual -Count appCount -Search "'DisplayName:testapp'"
# valid
Get-MgApplication -ConsistencyLevel eventual -Count appCount -Search '"DisplayName:testapp"'


# invalid
Get-MgApplication -Filter "SignInAudience ne 'AzureADMyOrg'"
# valid
Get-MgApplication -Filter "SignInAudience ne 'AzureADMyOrg'" -CountVariable count -ConsistencyLevel eventual

# valid
Get-MgApplication -Filter "startsWith(DisplayName, 'test')"
# invalid
Get-MgApplication -Filter "startsWith(DisplayName, 'test')" -OrderBy DisplayName
# valid
Get-MgApplication -Filter "startsWith(DisplayName, 'test')" -OrderBy DisplayName -CountVariable count -ConsistencyLevel eventual
...
AssignedPlans : {class AssignedPlan {
                  ...
                  ServicePlanId: d20bfa21-e9ae-43fc-93c2-20783f08
                }
                , class AssignedPlan {
                  AssignedTimestamp: 4/7/2022 9:23:53 PM
                  CapabilityStatus: Enabled
                  Service: PowerAppsService
                  ServicePlanId: d5368ca3-357e-4acb-9c21-8495fb02
                , class AssignedPlan {
                  AssignedTimestamp: 4/7/2022 9:23:53 PM
                  CapabilityStatus: Enabled
                  Service: LearningAppServiceInTeams
                  ServicePlanId: b76fb638-6ba6-402a-b9f9-83d28acb
                }
                , class AssignedPlan {
                  AssignedTimestamp: 10/17/2021 8:15:00 PM
                  CapabilityStatus: Enabled
                  Service: MIPExchangeSolutions
                  ServicePlanId: cd31b152-6326-4d1b-ae1b-997b6251
                }
                ...}
#>
...
Id            : xxxxxxxx-xxxx
DisplayName   : Aleksandar Nikolic
AssignedPlans : {d20bfa21-e9ae-43fc-93c2-20783f08, d5368ca3-357e-4acb-9c21-8495fb02, b76fb638-6ba6-402a-b9f9-83d28acb,
                cd31b152-6326-4d1b-ae1b-997b625182…}
#>
